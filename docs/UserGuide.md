...
| `/role`    | Role for the Internship             | Any text, numbers, or spaces (if left blank, it will be set to `UNKNOWN`)                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `/remark`  | Remark for the Internship           | Any text, numbers, or spaces (if left blank, it will be set to `unknown role`)                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
