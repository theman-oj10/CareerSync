...
* The field `LOCATION_ENUM` accepts only the following inputs: `unknown`, `remote`, `local`, `overseas` (case-insensitive)
   * Should you choose not to enter any input for this field, it will automatically be set to `UNKNOWN`
* The field `ROLE` allow the use of any text, number and/or spaces
  *  Should you choose not to enter any input for this field, it will automatically be set to `Unknown Role`
...
| `/loc`     | Location of Internship              | `remote`, `local`, `overseas` (else, it will be set to `UNKNOWN`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `/role`    | Role for the Internship             | Any text, numbers, or spaces  (else, it will be set to `unknown role`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
