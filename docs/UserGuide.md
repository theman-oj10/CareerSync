...
* The field `LOCATION_ENUM` accepts only the following inputs: `unknown`, `remote`, `local`, `overseas` (case-insensitive)
   * Should you choose to leave this blank, it will automatically be set to `UNKNOWN`
* The field `ROLE` allow the use of any text, number and/or spaces
  *  Should you choose to leave this blank, it will automatically be set to `Unknown Role`
...
| `/loc`     | Location of Internship              | `unknown`, `remote`, `local`, `overseas` <br> (if left blank, it will be set to `UNKNOWN`)                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `/role`    | Role for the Internship             | Any text, numbers, or spaces <br> (if left blank, it will be set to `Unknown Role`)                                                                                                                                                                                                                                                                                                                                                                                                                                             |
