...
| `/loc`     | Location of Internship              | `unknown`, `remote`, `local`, `overseas` (if left blank, it will be set to `UNKNOWN`)                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `/role`    | Role for the Internship             | Any text, numbers, or spaces (if left blank, it will be set to `unknown role`)                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
