 ...
 * As such, adding of internships uses Internship#isSameInternship(Internship) for equality
 * to ensure that the internship being added is unique in terms of identity in the
