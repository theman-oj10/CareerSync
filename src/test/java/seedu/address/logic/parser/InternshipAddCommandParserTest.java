...
public class InternshipAddCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, COMPANY_NAME_DESC_BOB + INVALID_CONTACT_NAME_DESC
                + INVALID_CONTACT_EMAIL_DESC + CONTACT_NUMBER_DESC_BOB + LOCATION_DESC_BOB + APPLICATION_STATUS_DESC_BOB
                + DESCRIPTION_DESC_BOB + ROLE_DESC_BOB, ContactName.MESSAGE_CONSTRAINTS);
    }
}
